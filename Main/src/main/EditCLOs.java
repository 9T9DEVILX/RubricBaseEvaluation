 ...
 * @author Hamad DEVIL
 */
public class EditCLOs extends javax.swing.JFrame {

    /**
     * Creates new form EditCLOs
     */
    public EditCLOs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("EDIT CLO's");

        jLabel3.setText("CLO3 :");

        jTextArea3.setColumns(20);
        jTextArea3.setRows(5);
        jScrollPane3.setViewportView(jTextArea3);

        jLabel4.setText("CLO4:");

        jTextArea4.setColumns(20);
        jTextArea4.setRows(5);
        jScrollPane4.setViewportView(jTextArea4);

        jLabel1.setText("CLO1 :");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        EditMangeFrame m1= new EditMangeFrame();
      m1.setVisible(true);
      this.setVisible(false);  // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      EditMangeFrame m = new EditMangeFrame();
      m.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditCLOs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
